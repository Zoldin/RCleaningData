      #in the R working directory please copy  UCI HAR folder that can be downloaded from 
      ...
      # set your working directory in a way that contains UCI HAR folder
      #setwd("/home/marija/Desktop/R_CLEANING_DA/")
      #getwd()


      #next line code is a control statement
      # if you see warning after it is executed please check working directory. Also see that UCI HAR folder exists there

if(!file.exists("./UCI HAR Dataset")){
  warning("UCI HAR folder is not in the working directory. Please change your working directory with setwd() command or save UCI HAR folder in R working directory!")}
...
dim(subject_train)
      ...
      #rename a variable from subjest train - descriptive labels
...
dim(subject_test)
      ...
      #rename a variable from subject test - descriptive labels
...
dim(y_test)
      ...
      #rename a variable from y_test - descriptive labels
